...
Ext.define('CompanyMgmt.view.MainViewportViewController', {
  extend: 'Ext.app.ViewController',
  alias: 'controller.mainviewport',

  requires: [
    'CompanyMgmt.view.InfoDialog'
  ],
  ...
  onCommandColumnClick: function (btn, event) {
    var viewCtr = this,
        command = btn.command,
        grid = viewCtr.lookupReference("companyMgmtGrid"),
  ...
  _openInfoDialog: function (record,type) {
    var viewCtr = this,
        dialog = Ext.create("CompanyMgmt.view.InfoDialog",{}),
    ...
    Ext.Ajax.request({
      url: FACADE_URL + '/company/view/'+record.getData().id,
      params: {},
      method : 'GET',
  ...
  _deleteRecord: function (record) {
    Ext.Msg.confirm("温馨提示","确定要删除该账号吗?",
      function(btn){
        if(btn == 'yes'){
          Ext.Ajax.request({
            url: FACADE_URL + '/company/delete/'+record.getData().id,
            params: {},
            method : 'GET',
            success: function(response){
