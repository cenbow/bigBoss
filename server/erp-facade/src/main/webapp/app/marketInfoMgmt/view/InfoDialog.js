 ...
 */
Ext.define('MarketInfoMgmt.view.InfoDialog', {
    extend: 'Ext.window.Window',
    alias: 'widget.infodialog',

    requires: [
        'MarketInfoMgmt.view.InfoDialogViewController',
        'MarketInfoMgmt.view.InfoDialogViewModel',
        'Common.ux.CustomVTypes',
        'MarketInfoMgmt.store.CategoryByUpClassIdComboboxStore',
        'MarketInfoMgmt.store.CompanyComboboxStore'
    ],
