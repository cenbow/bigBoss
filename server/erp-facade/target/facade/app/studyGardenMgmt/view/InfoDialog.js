 ...
 */
Ext.define('StudyGardenMgmt.view.InfoDialog', {
    extend: 'Ext.window.Window',
    alias: 'widget.infodialog',

    requires: [
        'StudyGardenMgmt.view.InfoDialogViewController',
        'StudyGardenMgmt.view.InfoDialogViewModel',
        'Common.ux.CustomVTypes',
        'StudyGardenMgmt.store.CategoryByUpClassIdComboboxStore',
        'StudyGardenMgmt.store.CompanyComboboxStore'
    ],
