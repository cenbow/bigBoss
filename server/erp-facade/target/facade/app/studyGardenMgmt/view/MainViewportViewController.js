...
Ext.define('StudyGardenMgmt.view.MainViewportViewController', {
  extend: 'Ext.app.ViewController',
  alias: 'controller.mainviewport',

  requires: [
    'StudyGardenMgmt.view.InfoDialog',
  ],
  ...
  _openPDFDialog: function (record, type) {
    var viewCtr = this,
      dialog = Ext.create("StudyGardenMgmt.view.PDFDialog", {}),
      dialogViewModel = dialog.getViewModel();
  ...
  _openInfoDialog: function (record, type) {
    var viewCtr = this,
      dialog = Ext.create("StudyGardenMgmt.view.InfoDialog", {}),
      dialogViewModel = dialog.getViewModel();
