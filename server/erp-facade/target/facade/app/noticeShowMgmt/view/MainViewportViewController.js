...
Ext.define('NoticeShowMgmt.view.MainViewportViewController', {
  extend: 'Ext.app.ViewController',
  alias: 'controller.mainviewport',

  requires: [
    'NoticeShowMgmt.view.InfoDialog',
  ],
  ...
  addClick: function () {
    var dialog = Ext.create("NoticeShowMgmt.view.InfoDialog", {}),
  ...
  _openPDFDialog: function (record, type) {
    var viewCtr = this,
      dialog = Ext.create("NoticeShowMgmt.view.PDFDialog", {}),
      dialogViewModel = dialog.getViewModel();
  ...
  _openInfoDialog: function (record, type) {
    var viewCtr = this,
      dialog = Ext.create("NoticeShowMgmt.view.InfoDialog", {}),
      dialogViewModel = dialog.getViewModel();
