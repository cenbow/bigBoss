Ext.define('ProductMgmt.view.CommonComboxWithDialog', {
  extend: 'Ext.form.field.ComboBox',
  alias: 'widget.productmgmt.commoncomboxwithdialog',
      ...
      success : function(response, options) {
        ...
        if (result.success) {
          TipsUtil.showTips("提示", result.data, TipsUtil.INFO, function() {
            var refreshToolbarStore = Ext.getStore(defaultConfig.refreshToolbarStore);
